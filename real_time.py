    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            #If it wasn't add person jpg
                ...
                suspect_num += 1
                cv2.imwrite("Suspects/" + "suspect_" + str(suspect_num) + ".jpg", small_frame)
                #load captured image
                suspect_image = face_recognition.load_image_file("Suspects/" +"suspect_" + str(suspect_num) + ".jpg")
